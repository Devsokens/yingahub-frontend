...
const mockApplications = [
    { id: "APP-001", student: "Jean Dupont", program: "Master in CS", country: "France", date: "Jan 10, 2026", status: "pending" },
    { id: "APP-002", student: "Aya Tanaka", program: "Bachelor in Engineering", country: "Japan", date: "Jan 12, 2026", status: "review" },
    { id: "APP-003", student: "Carlos Ruiz", program: "MBA", country: "Spain", date: "Jan 15, 2026", status: "accepted" },
    { id: "APP-004", student: "Sarah Miller", program: "Medicine", country: "USA", date: "Jan 18, 2026", status: "rejected" },
];
                                        ...
                                        <tr key={app.id} className="hover:bg-muted/20 transition-colors group">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-sm font-bold text-foreground">{app.student}</p>
